...
if(($animal === "Chien" && $vivant === false && $couleur === "Noir" && $yeux === "Bleu")||($animal === "Chien" && $vivant === true && $couleur === "Marron" && $yeux === "Bleu")||($animal === "Chat" && $vivant === true && $couleur === "Orange" && $yeux === "Bleu")) {
    echo 'Oui';
}
else {
    echo 'Non';
